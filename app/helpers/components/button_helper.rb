module Components::ButtonHelper
  def render_button(label = "", text: nil, variant: :default, as: :button, href: nil, data: {}, type: nil, form: nil, **options, &block)
    ...
    render "components/ui/button", text:, button_classes:, as:, href:, data:, type:, form:, **options
  end
end
