...
# 검색어 하이라이팅 헬퍼
#
# 검색 결과에서 검색어를 강조 표시하는 기능 제공
module SearchHighlightHelper
  # 검색어를 하이라이팅하여 표시
  # @param text [String] 원본 텍스트
  # @param query [String] 검색어
  # @return [ActiveSupport::SafeBuffer] 하이라이팅된 HTML
  ...
  # @param text [String] 원본 텍스트
  # @param query [String] 검색어
  # @param max_length [Integer] 최대 길이
  # @return [ActiveSupport::SafeBuffer] 하이라이팅된 스니펫 HTML
